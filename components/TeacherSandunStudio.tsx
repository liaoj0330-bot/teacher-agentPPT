...
const TeacherSectionEditor = dynamic(
  () => import("@/components/TeacherSectionEditor").then((module) => module.TeacherSectionEditor),
  { ssr: false }
);
...
export function TeacherSandunStudio({ project, workspaceIdentity, isExporting, isRefining, isGeneratingVisuals, isApplyingReviewFixes, isPresenting, generatedVisuals, onExport, onPresent, onClosePresent, onProjectChange, onRefine, onManualSave, isSavingSlide, teacherExportMeta, onGenerateVisuals, visualGenerationProgress, onApplyReviewFixes, onApplyPageReviewFixes, teacherVersions, teacherMaterials, isViewingCurrentVersion, onSelectVersion, teacherChat, isChatSending, onSendChat, isApplyingChatSuggestion, onApplyChatSuggestion, isAttachingMaterial, onAttachMaterial, isSubmittingReview, onSubmitReview }: TeacherSandunStudioProps) {
